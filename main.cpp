...

{
...

 {
        ...
        else if (strcmp(number,to3)==0)//ERROR2
        ...
        else if (strncmp(&number[1],&to2[1],7)==0)//ERROR3
        ...
        else if (strncmp(&number[2],&to2[2],6)==0)//ERROR4
        ...
        else if (strncmp(&number[3],&to3[3],5)==0)//ERROR5
        ...
        else if (strncmp(&number[5],&to1[5],3)==0)//ERROR6 
        ...
        else if (strncmp(&number[5],&six1[0],3)==0)//ERROR7 
